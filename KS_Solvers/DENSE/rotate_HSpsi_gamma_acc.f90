...
!----------------------------------------------------------------------------
SUBROUTINE rotate_HSpsi_gamma_acc( npwx, npw, nstart, nbnd, psi_d, hpsi_d, overlap, spsi_d, e_d )
  !----------------------------------------------------------------------------
  !
...
#endif   
!civn 
  write(*,*) 'using rotate_HSpsi_gamma_acc...'
!
  !
...
!$cuf kernel do (2) 
  ...
  RETURN
  !
END SUBROUTINE rotate_HSpsi_gamma_acc
